  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (email === 'demo123@gmail.com' && password === 'demo123') {
        // Store auth state
        localStorage.setItem('attorneyLoggedIn', 'true');
        localStorage.setItem('attorneyEmail', email);
        ...
        <div className="flex-1 flex items-center justify-center p-6">
          <div className="w-full max-w-md space-y-6">
            <div className="flex flex-col items-center space-y-2 text-center">
              ...
              <h1 className="text-3xl font-bold">Attorney Portal</h1>
              <p className="text-muted-foreground">
                Sign in to access your personalized legal analytics dashboard
              </p>
            </div>
